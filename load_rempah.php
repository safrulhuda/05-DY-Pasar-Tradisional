<?php
	include'koneksi.php';
	$sql="SELECT id_barang, a.nama, harga, toko, stock, keterangan, gambar FROM barang a JOIN penjual b ON a.id_penjual=b.id_penjual AND jenis='rempah-rempah' WHERE stock>0";
